...
public class PriorityGeneator {
	...
	public ArrayList<ArrayList<PeriodicIOTask>> assignPrioritiesByDM(ArrayList<ArrayList<PeriodicIOTask>> tasksToAssgin) {
		if (tasksToAssgin == null) {
			return null;
		}

		ArrayList<ArrayList<PeriodicIOTask>> tasks = new ArrayList<>(tasksToAssgin);
	...
	private void deadlineMonotonicPriorityAssignment(ArrayList<PeriodicIOTask> taskset, int NoT) {
